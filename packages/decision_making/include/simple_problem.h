...
class SimpleProblem{
    ...
    private:
        ...
        float intersection_trajectories[10][7] = {{1, 1, -1, -0.175, -0.275, 0.55, 0.525},
                                                 {1, 1, 2, 0.625, -0.275, 0.25, 0.28},
                                                 {0, 1, 3, 1, 0.375, 0, 0},
                                                 {0, 2, -1, 0, 0.25, 0, 0},
                                                 {1, 2, 1, 0.65, -0.3, 0.525, 0.55},                                                 
                                                 {1, 2, 3, 0.65, 0.5, 0.28, 0.25},
                                                 {1, 3, -1, -0.125, 0.525, 0.25, 0.28},
                                                 {0, 3, 1, 1, 0.125, 0},
                                                 {1, 3, 2, 0.675, 0.525, 0.55, 0.525},
                                                 {1, -1, 2, 0, 0, 0}};
